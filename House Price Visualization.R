...
#grouping the cleaned house prices by county, 
#towns, DOT and showing the average price for each group
...
# box plot to visualize average house prices in Kent and Surrey in 2022
Grouped_houseprice %>% 
  ...
  labs(title="Box Plot of Average House Prices By County of 2022") #setting label for the chart
